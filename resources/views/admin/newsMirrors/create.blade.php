...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.newsMirror.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.news-mirrors.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guid') ? 'is-invalid' : '' }}" type="text" name="guid" id="guid" value="{{ old('guid', '') }}">
                @if($errors->has('guid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('guid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pub_date') ? 'is-invalid' : '' }}" type="text" name="pub_date" id="pub_date" value="{{ old('pub_date', '') }}">
